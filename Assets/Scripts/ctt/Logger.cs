...
namespace CTT
{
    internal class Logger
    {
        ...
        public void Add(params object[] items)
        {
            ...
            var record = string.Join('\t', fullList);
        ...
        public string Save()
        {
            ...
            catch (Exception ex)
            {
                ...
                filename = null;
                Console.WriteLine($"Cannot save data into '{filename}':\n{ex.Message}");
            }

            return filename;
        }

        public static string SelectLogFolder(string folderName = null) => folderName ?? Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments);
